##################################################################################
#                   Register a scheduled task to map the Z Drive.                #
##################################################################################

########## Create log file. ##########
$logFileLocation = "C:\ProgramData\Remediations\DriveMapping\J-Drive"
$logFileName = "Create-J-Drive-Scheduled-Task.log"
...
$scriptLocation = "C:\ProgramData\Remediations\DriveMapping\J-Drive\Create-J-Drive.ps1"
$scriptContent = @'
##################################################################################
...
$logFileName = "Create-X-Drive-Regkeys.log"
...
WriteToLogFile "Checking for Drive Mapping Script here, $($scriptLocation)"
...
$schtaskName = "Map-X-Drive"
$schtaskPath = "Remediations"
WriteToLogFile "Creating new Scheduled task called, $($schtaskName)."
$action = New-ScheduledTaskAction -Execute 'Powershell.exe' -Argument '-WindowStyle hidden -command "& C:\ProgramData\Remediations\DriveMapping\X-Drive\Create-X-Drive.ps1"'
